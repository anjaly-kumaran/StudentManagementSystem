    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-2">
            <div class="input-group input-group-sm" style="">
                <a class="btn btn-block btn-crm" data-endpoint="{{ route('students.create') }}" data-target="modal-default" data-cache="false" data-toggle='modal' href='#' data-async="true">Add Student</a>
            </div>
        </div>
    </div>
@endsection
